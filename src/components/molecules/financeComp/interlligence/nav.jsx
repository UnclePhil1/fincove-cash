            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div className="flex space-x-[54px]">
                        <a href="#" className="border-b border-[#421638] text-[#421638] rounded px-3 py-2 text-sm font-medium" aria-current="page">Overview </a>
                        <a href="#" className="text-[#421638] hover:border-b hover:border-[#421638] rounded px-3 py-2 text-sm font-medium">Income</a>
                        <a href="#" className="text-[#421638] hover:border-b hover:border-[#421638] rounded px-3 py-2 text-sm font-medium">Expenses</a>
                        <a href="#" className="text-[#421638] hover:border-b hover:border-[#421638] rounded px-3 py-2 text-sm font-medium">Labels</a>
                        <a href="#" className="text-[#421638] hover:border-b hover:border-[#421638] rounded px-3 py-2 text-sm font-medium">History</a>
                    </div>
                    </div>
                </div>
